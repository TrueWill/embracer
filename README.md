...
* Morality Merits (costs based on Clan, so reset if change) (Morality goes to 4 and can't raise) (count against total Merits) (maybe have discount for clan and/or isMorality properties?) (selector for path?)
