...
const setStartingDotsForSkills = (state, trait, startingDots) => {
...
const setStartingDotsForBackgrounds = (state, trait, startingDots) => {
...
const setStartingDotsForInClan = (state, trait, startingDots) => {
